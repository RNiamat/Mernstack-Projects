...
const Auth = () => {
    ...
    return (
        <div onClick = {()=> setShowUserLogin(false)} className="fixed top-0 bottom-0 left-0 right-0 flex items-center justify-center bg-black/50 text-gray-600">
            <form
            ...
            >
                ...
                <div className="mt-5 text-left">
                    ...
                    font-size: 14px hover:text-yellow-500" href="#" >
                        Forgot password?
                    </a>
                </div>

                <button onClick={() => {setUser(true); setShowUserLogin(false);}} type="submit" className="mt-2 w-full h-11 rounded-full text-black bg-yellow-500 hover:text-white hover:bg-black hover:opacity-90 transition-opacity" >
                ...
                <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-3 mb-11">
                    ...
                    <button type="button" className="text-black  hover:text-yellow-500" onClick={() => setState((prev) => prev === "login" ? "register" : "login")} >
